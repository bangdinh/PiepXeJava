...
public class UserEntityJsonMapper {
    ...
    /**
     * Transform from valid json string to {@link User}.
     *
     * @param userJsonResponse A json representing a user profile.
     * @return {@link User}.
     * @throws JsonSyntaxException if the json string is not a valid json structure.
     */
    public User transformUserEntity(String userJsonResponse) throws JsonSyntaxException {
        final Type userEntityType = new TypeToken<User>() {
        }.getType();
        return this.gson.fromJson(userJsonResponse, userEntityType);
    }

    /**
     * Transform from valid json string to List of {@link User}.
     *
     * @param userListJsonResponse A json representing a collection of users.
     * @return List of {@link User}.
     * @throws JsonSyntaxException if the json string is not a valid json structure.
     */
    public List<User> transformUserEntityCollection(String userListJsonResponse)
            throws JsonSyntaxException {
        final Type listOfUserEntityType = new TypeToken<List<User>>() {
        }.getType();
